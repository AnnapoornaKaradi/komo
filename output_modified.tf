...
output "container_registry" {
	value = {
		...
		public_network_access_enabled = azurerm_container_registry.acr1.public_network_access_enabled
		network_rule_bypass_option = azurerm_container_registry.acr1.public_network_access_enabled
	}
}
